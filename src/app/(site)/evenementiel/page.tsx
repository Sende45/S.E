...
const prestations = [
  {
    ...
    desc: "Un chef de projet gère le timing et les prestataires pour que vous profitiez.",
  },
  {
    icon: Package,
    titre: "Logistique",
    desc: "Location, transport, montage et démontage entièrement pris en charge.",
  },
  {
    icon: Users,
    titre: "Personnel qualifié",
    desc: "Serveurs, hôtesses, barmen et agents de sécurité formés à l'exigence S.E.",
  },
];
...
export default async function EvenementielPage() {
  const galerie = await prisma.realisation.findMany({
    where: {
      categorie: CategorieRealisation.EVENEMENTIEL,
    },
    orderBy: {
      createdAt: "desc",
    },
